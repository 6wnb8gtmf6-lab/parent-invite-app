            ...
            <div className="flex flex-wrap gap-6">
                ...
                <label className="flex items-center space-x-3 cursor-pointer">
                    <input
                        type="checkbox"
                        name="sendReminder"
                        defaultChecked={template?.sendReminder ?? true}
                        className="w-5 h-5 text-indigo-600 rounded focus:ring-indigo-500 border-gray-300"
                    />
                    <span className="text-gray-700 font-medium">Send Reminder Email</span>
                </label>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Reminder Hours Before (Default: 24)</label>
                    <input
                        type="number"
                        name="reminderHoursBefore"
                        defaultValue={template?.reminderHoursBefore ?? 24}
                        min="1"
                        className="block w-full rounded-xl border-2 border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 px-4 py-3"
                    />
                </div>
